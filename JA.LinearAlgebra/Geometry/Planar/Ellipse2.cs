...
namespace JA.Geometry.Planar
{
        ...
        IFormattable
    {
        ...
        public float FocalDistance => (float)Sqrt(MajorAxis*MajorAxis - MinorAxis*MinorAxis);
        public Point2 Focus1 => Center + Vector2.UnitX * FocalDistance;
        public Point2 Focus2 => Center - Vector2.UnitX * FocalDistance;
        ...
        public float GetPerimeterApproximation()
        {
        ...
        public Point2 GetPoint(float paramAngle)
        {
            var delta = Geometry.Elliptical(MajorAxis, MinorAxis, paramAngle);
            return Center + delta;
        }
